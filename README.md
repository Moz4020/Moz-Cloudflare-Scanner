...
moz-cloudflare-scanner-linux-amd64-0.1.3.5.tar.gz
```
...
```bash
tar -xzf moz-cloudflare-scanner-linux-amd64-0.1.3.5.tar.gz
...
```text
dist/moz-cloudflare-scanner-linux-amd64-0.1.3.5.tar.gz
```
